...
# CHANNELS - Link daal do
SOURCE_CHANNEL = "https://t.me/xforcegroupBOT"  # Ya sirf "xforcegroupBOT"
...
cc_regex = re.compile(r"\b((4\d{12}(?:\d{3})?)|(5[1-5]\d{14}))\s*\|\s*\d{1,2}\s*\|\s*\d{2,4}\s*\|\s*\d{3,4}\b")
